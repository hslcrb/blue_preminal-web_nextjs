export default function Footer() {
    return (
        <footer className="border-t border-slate-200 dark:border-neutral-dark bg-background-light dark:bg-background-dark py-12 px-6 lg:px-40">
            <div className="flex flex-col md:flex-row justify-between items-center gap-8 max-w-[1200px] mx-auto">
                <div className="flex items-center gap-2 text-slate-900 dark:text-white opacity-80">
                    <div className="size-6 rounded-full bg-primary flex items-center justify-center text-white text-[10px]">
